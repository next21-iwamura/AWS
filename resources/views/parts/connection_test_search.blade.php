...
<body>
    ...
    <div class="container">
        ...
        <!-- <form method="POST" action="/laravel/connection_test_search" accept-charset="UTF-8" enctype="multipart/form-data">-->
       <form method="POST" action="/connection_test_search" accept-charset="UTF-8" enctype="multipart/form-data">
