...
.ul1b_past:hover,.ul1b:hover{opacity:0.8;font-weight:bold;/*border-top:1px solid red;border-bottom:1px solid red;*/}
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.10/js/i18n/ja.js"></script>
    ...
    <!-- 全体の大枠 start -->
        ...
        <!-- FORM start -->
            <!-- <form action="/laravel/analysis_test_search" method="POST" enctype="multipart/form-data"> -->
            <form action="/analysis_test_search" method="POST" enctype="multipart/form-data">
                <!--{{ csrf_field() }}-->
                @csrf
                <!-- 固定ヘッダー START -->
                <div class="header">
