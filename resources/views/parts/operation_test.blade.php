...
.btn:hover{background:#666666;color:#ffffff;}
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.10/js/i18n/ja.js"></script>
    ...
    <!-- 全体の大枠 start -->
        ...
        <!-- FORM start -->
            <!--<form action="/laravel/operation_test" method="POST">-->
            <form action="/operation_test" method="POST" enctype="multipart/form-data">
                <!--{{ csrf_field() }}-->
                @csrf
            <!-- 左右大枠 start -->
                <div class="cont">
                        ...
                        <!-- 使用方法エリア -->
                            <div style="position:relative; width:100%;">
                                <div>
                                    ...
                                    <p style="text-indent:1em;">・NC作業時に同じIDへの違う依頼が複数あった場合は最新の依頼が反映される</p>
                                    ...
                                    <p style="text-indent:2em;">https://lomo-jackroad.ssl-lolipop.jp/laravel/operation_status_test</p>
                                    </div>
                                </div>
                            </div>
