...
<body>
    ...
    <div class="container">
        ...
        <!--<form method="POST" action="/laravel/kaitori_test" accept-charset="UTF-8" enctype="multipart/form-data">-->
        <form method="POST" action="/kaitori_test" accept-charset="UTF-8" enctype="multipart/form-data">
